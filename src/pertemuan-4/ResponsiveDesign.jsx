...
function ResponsiveText(){
    return (
        //breakpoint pada tailwind cara kita mengatur responsive nya contoh : md:text-lg -> md(ukuran medium) text menjadi lg(ukuran large)
...
function ResponsiveWidth(){
    return (
        <div className="mb-4">
            ...
            {/* md:flex-row -> menyesuaikan dengan kondisi besarnya layar menjadi satu baris sedangkan flex-col -> menjadikannya kolom*/}
...
function ResponsiveLayout(){
    return (
        <div>
            ...
            {/* Mengikuti besarnya layar menentukan banyak nya kolom ex: sm=2colom, md=3colom, lg=4colom*/}
