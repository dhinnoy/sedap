    ...
    return (
        <div id="header-container" className="flex justify-between items-center p-4">
            ...
            <div id="search-bar" className="relative w-full max-w-lg">
                <input
                    id="search-input"
                    className="font-barlow border border-gray-100 p-2 pr-10 bg-white w-full max-w-lg rounded-md outline-none"
                    type="text"
            ...
            <div id="icons-container" className="flex items-center space-x-4">
                ...
                {/* Profile Section */}
                <div id="profile-container" className="font-barlow flex items-center space-x-4 border-l pl-4 border-gray-300">
                    <span id="profile-text">
                        Hello, <b>Dhini Handayani</b>
                    </span>
                    <img
                        id="profile-avatar"
